...
export default function UserTable({ users, loading, page, rowsPerPage, totalCount, onPageChange, onRowsPerPageChange, onEdit, onDelete, onStatusChange, searchValue, onSearchChange, headerActions, sortBy, sortOrder, onSort }: UserTableProps) {
